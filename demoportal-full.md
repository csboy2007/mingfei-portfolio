...
- Led the design of the Demo Portal from 0 → 1 as the founding designer
- Defined structured demo discovery through metadata & taxonomy modeling
- Redesigned the Demo Detail Page to support confident evaluation and reuse at scale
- Introduced Collection with role-based permissions for event coordination
- Established AI-era design validation practices (Kiro & vibe coding)

## What I delivered

- Portal Discoverability Upgrade (Phase 1) [GO](#phase1)
- Demo Detail Page Decision Support (Phase 2) [GO](#phase2)
- Event Collections with Role Permissions (Phase 3) [GO](#phase3-collection)
- Vibe Coding Validation + Meet Figma (Phase 3 extension) [GO](#meet-figma)
...
![The Birth of GenAI Labs](images/dp_1.png)
...
![GenAI Labs Demo Portal UI/UX discussion – Phase 1 document](images/DP_2.1.1.png)
...
Instead of treating Phase 1 as a search optimization effort, I reframed it as a structured discoverability strategy across three stages: pre-search, in-search, and post-search (see ["Improve discoverability of demos on GenAI Labs Demo Portal"](docs/DP/Improve%20discoverability%20of%20demos%20on%20GenAI%20Labs%20Demo%20Portal.pdf)).

![Improve discoverability of demos on GenAI Labs Demo Portal](images/DP_2.1.2.png)
...
We explored three versions and selected the rightmost one — the most scannable format — to reduce friction. The goal was not engagement for its own sake. The goal was visibility with minimal overhead.

![Three newsletter versions explored, rightmost selected](images/DP_2.1.3.png)
...
![Industry value mapping category taxonomy](images/DP_2.1.4.png)
...
![In-search landing page](images/2.2.1.png)
...
![Post-search My Favorites](images/DP_2.3.png)
...
![Homepage — Structuring System Recommendation Before Search](images/DP%202.4.png)
...
![Adoption metrics via Amazon QuickSight](images/DP_2.5.png)
...
[Watch video on YouTube](https://www.youtube.com/watch?v=LY7m5LQliAo&t=9103s)
...
Finding a demo was no longer sufficient.
...
![Comparison between the initial v0.1 screenshot and Phase 2 redesign (v2.0)](images/DP_3.1.1.png)

![Phase 2 Demo Detail Page redesign](images/DP_3.1.png)
...
In the re:Invent recap report ([see report (Chapter 3 only)](docs/DP/reInvent%20report-section%203.pdf)), I reframed the Portal not as a discovery tool, but as infrastructure embedded in the full lifecycle of how SAs operate.

![SA End-to-End Workflow from re:Invent recap report](images/DP_3.2.png)
...
To investigate further, I secured focused time and resources to run a workshop with one SA and one product manager. Given the team's size and priorities, this required deliberate coordination rather than being an assumed step (see [Workshop report](docs/DP/Workshop%20report.pdf), Chapter 1 only).

![Workshop report](images/DP_3.3.png)
...
In the workshop, we consolidated the previously identified friction points into structured requirement clusters (see [Detail page usability testing report](docs/DP/Detail%20page%20usability%20testing%20.pdf), Chapters 1–4 only).

![Workshop requirement clusters](images/DP_3.4.3.png)
...
![Functional and emotional requirements](images/DP_3.4.4.png)
...
![Workshop Whiteboard Clustering Photo – Reference: 20250407 Workshop Summary](images/DP_3.4.5.png)
...
![Top Section Layout](images/DP_3.4.6.png)
...
![Technical Block / Metadata Section Layout](images/DP_3.4.7.png)
...
![Layer 2 — Technical Block / Metadata Section](images/DP_3.4.8.png)
...
![Right Column / Quick Links / Owner Section](images/DP_3.4.10.png)
...
![A/B testing summary – Prototype A vs Prototype B + ratings](images/placeholder-ab-testing-summary.png)

#### Test setup

I designed a focused usability study scoped to one page: the Demo Detail Page, tested in two variants (see [Usability testing plan](docs/DP/GenAI%20Labs%20Demo%20Portal%20-%20Usability%20testing%20plan%20-%20demo%20detail%20page.pdf)).
...
![Prototype A vs Prototype B](images/DP_3.5.2.png)
...
This mix helped validate both presenter needs and builder expectations around how demo context should be communicated (see [Usability testing report](docs/DP/GenAI%20Labs%20Demo%20Portal%20-%20Usability%20testing%20report%20-%20demo%20detail%20page%202.pdf)).
...
![Overall impressions and Widget feedback](images/DP_3.5.3.png)
...
![Discovery Journey Diagram from Section 3.2](images/DP_3.6.png)

*Discovery flow extended from Search → Evaluate to Search → Evaluate → Save → Reuse*

![Detail Page with Favorite Button Highlighted](images/DP_3.6.1.png)
...
![3.7 System Upgrade Outcome](images/DP_3.7.png)
...
![Sales → Marketing transition + SA → PMM expansion](images/DP_4.1.png)
...
![UI comparison: Favorites vs Collection](images/DP_4.2.png)
...
![Create Collection flow screenshot](images/DP_4.3.png)
...
A sample of the Collection card implementation — a vibe coding example — is attached for reference ([view sample](collection-card-samples.html)).

![Kiro testing environment or code validation screenshot](images/DP_4.5.png)
...
![Collection display style selection](images/DP_4.5.1.png)
...
![Style parameter configuration](images/DP_4.5.2.png)
...
![Event publishing without new system layer](images/DP_4.5.3.png)
...
This led to an internal initiative titled Meet Figma (see [Meet Figma document](docs/DP/Meet%20figma.pdf)).
...
Supporting demo file: [Meet Figma demo file](https://www.figma.com/design/EMdtFdlYelur0tFsVaeYTE/Meet-Figma-demo-file?node-id=0-1&t=h2W5dAr6tLJely60-1) (Access available upon request.)
...
Over these months, the Demo Portal evolved from: A searchable directory → A discoverability system → A decision-support interface → A governance-aware collaboration layer → A lightweight event publishing mechanism.
...
[NEXT PROJECT—Watchlist Part 1](vawl.html)
